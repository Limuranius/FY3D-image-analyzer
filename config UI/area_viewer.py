...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_col_avg = QtWidgets.QLabel(self.frame_3)
        self.label_col_avg.setObjectName("label_col_avg")
        self.horizontalLayout_2.addWidget(self.label_col_avg)
        self.label_sensor_deviation = QtWidgets.QLabel(self.frame_3)
        self.label_sensor_deviation.setObjectName("label_sensor_deviation")
        self.horizontalLayout_2.addWidget(self.label_sensor_deviation)
